$(function () {
    ...
    function feiru() {
        if ((leng - 1) > i) {
            ...
            $('.begin').html('<a href="Memories.html" style="text-decoration: none;color: #fff;background: pink;display: inline-block;padding: 10px;border: 2px solid #fff;">一岁一礼，满载欢喜</a>');
            $('.begin').fadeIn();
            return;
        }
    };
